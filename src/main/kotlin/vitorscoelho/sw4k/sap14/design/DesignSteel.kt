package vitorscoelho.sw4k.sap14.design
...
interface DesignSteelV14 : SapComponent {
     ...
     */
    fun getTargetDispl(numberItems: IntByRef, loadCase: StringArrayByRef, point: StringArrayByRef, displ: DoubleArrayByRef, active: BooleanByRef): Int =
     ...
     * @return zero if the targets are successfully retrieved; otherwise it returns a nonzero value.
     */
    fun getTargetPeriod(numberItems: IntByRef, modalCase: StringByRef, mode: IntArrayByRef, period: DoubleArrayByRef, active: BooleanByRef): Int =
     ...
     */
    fun setTargetDispl(numberItems: Int, loadCase: StringArrayByRef, point: StringArrayByRef, displ: DoubleArrayByRef, active: Boolean = true): Int =
     ...
     * @return zero if the targets are successfully set; otherwise it returns a nonzero value.
     */
    fun setTargetPeriod(numberItems: Int, modalCase: String, mode: IntArrayByRef, period: DoubleArrayByRef, active: Boolean = true): Int =
