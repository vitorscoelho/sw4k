...
import vitorscoelho.sw4k.sap14.enums.ProportionalModalDampingType
import vitorscoelho.sw4k.sap14.enums.TimeIntegrationType
import vitorscoelho.sw4k.sap14.enums.NLGeomType
import vitorscoelho.sw4k.sap14.enums.LoadType

class DirHistNonlinear(programName: String) : DirHistNonlinearV14 {
...
interface DirHistNonlinearV14 : SapComponent {
     ...
     */
    fun getSolControlParameters(name: String, dTMax: DoubleByRef, dTMin: DoubleByRef, maxIterCS: IntByRef, maxIterNR: IntByRef, tolConvD: DoubleByRef, useEventStepping: BooleanByRef, tolEventD: DoubleByRef, maxLineSearchPerIter: IntByRef, tolLineSearch: DoubleByRef, lineSearchStepFact: DoubleByRef): Int =
