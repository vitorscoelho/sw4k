...
import vitorscoelho.sw4k.sap14.enums.TimeHistoryMotionType

class ModHistLinear(programName: String) : ModHistLinearV14 {
...
interface ModHistLinearV14 : SapComponent {
     ...
     */
    fun getMotionType(name: String, motionType: IntByRef): Int =
