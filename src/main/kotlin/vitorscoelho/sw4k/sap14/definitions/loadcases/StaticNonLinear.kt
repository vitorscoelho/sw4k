...
class StaticNonLinear(loadCases: LoadCases) : SapComponent("${loadCases.sapModel.sapObject.sapObjectString}.cCaseStaticNonLinear"), StaticNonLinearV14 {
    override fun setCase(name: String): Int = callFunctionInt("SetCase", name)

    override fun setGeometricNonlinearity(name: String, nLGeomType: Int): Int =
