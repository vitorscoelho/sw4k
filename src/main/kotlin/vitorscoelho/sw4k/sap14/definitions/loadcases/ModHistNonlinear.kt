...
import vitorscoelho.sw4k.sap14.enums.DampingType
import vitorscoelho.sw4k.sap14.enums.LoadType

class ModHistNonlinear(programName: String) : ModHistNonlinearV14 {
...
interface ModHistNonlinearV14 : SapComponent {
     ...
     */
    fun getSolControlParameters(name: String, tstat: DoubleByRef, dtmax: DoubleByRef, dtmin: DoubleByRef, ftol: DoubleByRef, etol: DoubleByRef, itmax: IntByRef, itmin: IntByRef, cf: DoubleByRef): Int =
