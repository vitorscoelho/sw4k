...
class ModifierFrame(programName: String) : ModifierFrameV14 {
...
interface ModifierFrameV14 : SapComponent {
     ...
     * @param myName This is a one-dimensional array of frame property modifier names. The MyName array is created as a dynamic, zero-based, array by the API user:
