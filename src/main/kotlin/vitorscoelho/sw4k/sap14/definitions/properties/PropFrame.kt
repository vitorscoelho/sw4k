...
class PropFrame internal constructor(sapModel: SapModel) : SapComponent("${sapModel.sapObject.sapObjectString}.cPropFrame") {
     ...
     * @param startSec This is an array of the names of the frame section properties at the start of each segment. Auto select lists and nonprismatic sections are not allowed in this array.
     * @param endSec This is an array of the names of the frame section properties at the end of each segment. Auto select lists and nonprismatic sections are not allowed in this array.
     ...
     * @param myType This is an array of [LengthType], indicating the length type for each segment.
     * @param eI33 This is an array of [VariationSegmentType], indicating the variation type for EI33 and EI22 in each segment.
     * @param eI22 This is an array of [VariationSegmentType], indicating the variation type for EI33 and EI22 in each segment.
     ...
     */
//    fun setNonPrismatic(name: String, numberItems: Int, startSec: StringArrayByRef, endSec: StringArrayByRef, myLength: DoubleArrayByRef, myType: EnumArrayByRef<LengthType>, eI33: EnumArrayByRef<VariationSegmentType>, eI22: EnumArrayByRef<VariationSegmentType>, color: Int = -1, notes: String = "", GUID: String = ""): Int =
//            callFunctionInt("SetNonPrismatic", name, numberItems, startSec, endSec, myLength, myType, eI33, eI22, color, notes, GUID)
    ...
    fun setPrecastI(name: String, matProp: String, b: DoubleArrayByRef, d: DoubleArrayByRef, color: Int = -1, notes: String = "", GUID: String = ""): Int {
        ...
        return callFunctionInt("SetPrecastI", name, matProp, b, d, color, notes, GUID)
    }
