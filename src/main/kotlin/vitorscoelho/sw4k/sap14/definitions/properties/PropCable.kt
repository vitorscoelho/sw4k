...
class PropCable(programName: String) : PropCableV14 {
...
interface PropCableV14 : SapComponent {
     ...
     * @param myName This is a one-dimensional array of cable property names. The MyName array is created as a dynamic, zero-based, array by the API user:
     ...
     */
    fun getProp (name:String,matProp:StringByRef,area:DoubleByRef,color:IntByRef,notes:StringByRef,GUID:StringByRef):Int=
