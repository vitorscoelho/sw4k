...
class PropSolid(programName: String) : PropSolidV14 {
...
interface PropSolidV14 : SapComponent {
     ...
     * @param myName This is a one-dimensional array of solid property names. The MyName array is created as a dynamic, zero-based, array by the API user:
