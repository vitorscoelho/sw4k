...
class Analyze internal constructor(sapModel: SapModel) : SapComponent("${sapModel.sapObject.sapObjectString}.cAnalyze") {
    /**
    ...
    fun setActiveDOF(DOF: BooleanArrayByRef): Int =
            callFunctionInt("SetActiveDOF", DOF)
