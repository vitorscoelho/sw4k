...
interface FrameObjV14 : SapComponent {
     ...
     */
    fun getAutoMesh(name: String, autoMesh: BooleanByRef, autoMeshAtPoints: BooleanByRef, autoMeshAtLines: BooleanByRef, numSegs: IntByRef, autoMeshMaxLength: DoubleByRef): Int =
     ...
     */
    fun getCurved(numberItems: IntByRef, myType: IntArrayByRef, gx: DoubleArrayByRef, gy: DoubleArrayByRef, gz: DoubleArrayByRef, pointName: StringArrayByRef, radius: DoubleArrayByRef, numSegs: IntArrayByRef): Int =
     ...
     */
    fun getDesignProcedure(name: String, myType: IntByRef): Int =
     ...
     */
    fun getEndLengthOffset(name: String, autoOffset: BooleanByRef, length1: DoubleByRef, length2: DoubleByRef, rz: DoubleByRef): Int =
     ...
     */
    fun getEndSkew(name: String, skewI: DoubleByRef, skewJ: DoubleByRef): Int =
     ...
     */
    fun getFireproofing(name: String, myType: IntByRef, thickness: DoubleByRef, perimeter: DoubleByRef, density: DoubleByRef, tf: BooleanByRef): Int =
     ...
     */
    fun getInsertionPoint(name: String, cardinalPoint: IntByRef, mirror2: BooleanByRef, stiffTransform: BooleanByRef, offset1: DoubleArrayByRef, offset2: DoubleArrayByRef, cSys: StringByRef): Int =
     ...
     */
    fun getLateralBracing(name: String, numberItems: IntByRef, frameName: StringArrayByRef, myType: IntArrayByRef, loc: IntArrayByRef, rd1: DoubleArrayByRef, rd2: DoubleArrayByRef, dist1: DoubleArrayByRef, dist2: DoubleArrayByRef): Int =
     ...
     */
    fun getLoadDeformation(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, dof1: BooleanArrayByRef, dof2: BooleanArrayByRef, dof3: BooleanArrayByRef, dof4: BooleanArrayByRef, dof5: BooleanArrayByRef, dof6: BooleanArrayByRef, u1: DoubleArrayByRef, u2: DoubleArrayByRef, u3: DoubleArrayByRef, r1: DoubleArrayByRef, r2: DoubleArrayByRef, r3: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the load assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun getLoadDistributed(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, myType: IntArrayByRef, cSys: StringArrayByRef, dir: IntArrayByRef, rd1: DoubleArrayByRef, rd2: DoubleArrayByRef, dist1: DoubleArrayByRef, dist2: DoubleArrayByRef, val1: DoubleArrayByRef, val2: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the load assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun getLoadGravity(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, cSys: StringArrayByRef, x: DoubleArrayByRef, y: DoubleArrayByRef, z: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the load assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun getLoadPoint(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, myType: IntArrayByRef, cSys: StringArrayByRef, dir: IntArrayByRef, relDist: DoubleArrayByRef, dist: DoubleArrayByRef, value: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     */
    fun getLoadStrain(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, dof: IntArrayByRef, value: DoubleArrayByRef, patternName: StringArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     */
    fun getLoadTargetForce(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, dof1: BooleanArrayByRef, dof2: BooleanArrayByRef, dof3: BooleanArrayByRef, dof4: BooleanArrayByRef, dof5: BooleanArrayByRef, dof6: BooleanArrayByRef, p: DoubleArrayByRef, v2: DoubleArrayByRef, v3: DoubleArrayByRef, t: DoubleArrayByRef, m2: DoubleArrayByRef, m3: DoubleArrayByRef, t1: DoubleArrayByRef, t2: DoubleArrayByRef, t3: DoubleArrayByRef, t4: DoubleArrayByRef, t5: DoubleArrayByRef, t6: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the load assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun getLoadTemperature(name: String, numberItems: IntByRef, frameName: StringArrayByRef, loadPat: StringArrayByRef, myType: IntArrayByRef, value: DoubleArrayByRef, patternName: StringArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     */
    fun getSectionNonPrismatic(name: String, propName: StringByRef, sVarTotalLength: DoubleByRef, sVarRelStartLoc: DoubleByRef): Int =
     ...
     */
    fun getSection(name: String, propName: StringByRef, sAuto: StringByRef): Int =
     ...
     * @return zero if the assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun getSpring(name: String, numberSprings: IntByRef, myType: IntArrayByRef, s: DoubleArrayByRef, simpleSpringType: IntArrayByRef, linkProp: StringArrayByRef, springLocalOneType: IntArrayByRef, dir: IntArrayByRef, plane23Angle: DoubleArrayByRef, vecX: DoubleArrayByRef, vecY: DoubleArrayByRef, vecZ: DoubleArrayByRef, cSys: StringArrayByRef, ang: DoubleArrayByRef): Int =
     ...
     */
    fun getType(name: String, myType: StringByRef): Int =
     ...
     */
    fun setInsertionPoint(name: String, cardinalPoint: Int, mirror2: Boolean, stiffTransform: Boolean, offset1: DoubleArrayByRef, offset2: DoubleArrayByRef, cSys: String = "Local", itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the assignments are successfully retrieved, otherwise it returns a nonzero value.
     */
    fun setReleases(name: String, ii: BooleanArrayByRef, jj: BooleanArrayByRef, startValue: DoubleArrayByRef, endValue: DoubleArrayByRef, itemType: Int = ItemType.OBJECT.sapId): Int =
     ...
     * @return zero if the assignments are successfully applied, otherwise it returns a nonzero value.
     */
    fun setSpring(name: String, myType: Int, s: Double, simpleSpringType: Int, linkProp: String, springLocalOneType: Int, dir: Int, plane23Angle: Double, vec: DoubleArrayByRef, ang: Double, replace: Boolean, cSys: String = "Local", itemType: Int = ItemType.OBJECT.sapId): Int =
