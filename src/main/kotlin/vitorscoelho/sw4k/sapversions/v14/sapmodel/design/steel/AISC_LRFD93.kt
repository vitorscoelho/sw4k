...
interface AISC_LRFD93V14 : SapComponent {
/**
...
* @param item This is an integer between 1 and 35, inclusive, indicating the overwrite item considered.
* * 1 = Framing type
...
* @param item This is an integer between 1 and 15, inclusive, indicating the preference item considered.
* * 1 = Framing type
* * 2 = Phi bending
* * 3 = Phi compression
* * 4 = Phi tension
...
* @return zero if the item is successfully set; otherwise it returns a nonzero value.
*/
fun setPreference (item:Int,value: ADoubleByRef = DoubleByRef.UNNECESSARY):Int=
callFunctionInt("GetPreference",item,value)
