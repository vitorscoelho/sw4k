...
interface FuncV14 : SapComponent {
     ...
     */
    fun getNameList(numberNames: AIntByRef = IntByRef.UNNECESSARY, myName: AStringArrayByRef = StringArrayByRef.UNNECESSARY, funcType: Int = 0): Int =
     ...
     */
    fun getType(name: String, funcType: AIntByRef = IntByRef.UNNECESSARY, addType: AIntByRef = IntByRef.UNNECESSARY): Int =
     ...
     */
    fun getValues(name: String, numberItems: AIntByRef = IntByRef.UNNECESSARY, myTime: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY, value: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY): Int =
