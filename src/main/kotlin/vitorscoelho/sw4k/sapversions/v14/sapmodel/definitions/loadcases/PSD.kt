...
import vitorscoelho.sw4k.sapenums.FrequencyUnits
import vitorscoelho.sw4k.sapenums.HystereticDampingType
...
interface PSDV14 : SapComponent {
     ...
     * @param name The name of an existing power spectral density analysis case that has constant damping.
     ...
     * @param name The name of an existing power spectral density analysis case that has interpolated damping.
     ...
     * @param name The name of an existing power spectral density analysis case.
     ...
     * @param loadType This is an array that includes either Load or Accel, indicating the type of each load assigned to the load case ([LoadType] enumeration).
     ...
     * @param func This is an array that includes the name of the power spectral density function associated with each load.
     ...
     * @param name The name of an existing power spectral density analysis case.
     * @param hysIntFreqUnits This is either 1 or 2, indicating the units for the frequency ([HystereticDampingType] enumeration).
     * * 1 = Hz (cyc/s)
     * * 2 = RPM
     * @param hysIntNumFreqs The number of sets of frequency, mass coefficient and stiffness coefficient data.
     * @param hysIntFreq This is an array of frequencies. The frequency is either in Hz or RPM depending on the value of HysIntFreqUnits.
