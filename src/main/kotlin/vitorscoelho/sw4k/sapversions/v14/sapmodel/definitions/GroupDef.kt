...
interface GroupDefV14 : SapComponent {
     ...
     */
    fun getAssignments(name: String, numberItems: AIntByRef = IntByRef.UNNECESSARY, objectType: AIntArrayByRef = IntArrayByRef.UNNECESSARY, objectName: AStringArrayByRef = StringArrayByRef.UNNECESSARY): Int =
     ...
     */
    fun getGroup(name: String, color: AIntByRef = IntByRef.UNNECESSARY, specifiedForSelection: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForSectionCutDefinition: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForSteelDesign: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForConcreteDesign: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForAluminumDesign: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForColdFormedDesign: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForStaticNLActiveStage: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForBridgeResponseOutput: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForAutoSeismicOutput: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForAutoWindOutput: ABooleanByRef = BooleanByRef.UNNECESSARY, specifiedForMassAndWeight: ABooleanByRef = BooleanByRef.UNNECESSARY): Int =
