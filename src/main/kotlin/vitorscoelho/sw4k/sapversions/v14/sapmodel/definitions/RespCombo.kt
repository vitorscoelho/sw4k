...
import vitorscoelho.sw4k.sap.sapmodel.enums.CType
import vitorscoelho.sw4k.sap.sapmodel.enums.ComboType
...
interface RespComboV14 : SapComponent {
     ...
     */
    fun countCase(name: String, count: IntByRef): Int =
     ...
     */
    fun getCaseList(name: String, numberItems: IntByRef, cType: IntArrayByRef, cName: StringArrayByRef, sF: DoubleArrayByRef): Int =
     ...
     */
    fun getNote(name: String, note: StringByRef): Int =
     ...
     */
    fun getType(name: String, comboType: IntByRef): Int =
