...
interface AreaObjV14 : SapComponent {
     ...
     */
    fun getAutoMesh(name: String, meshType: AIntByRef = IntByRef.UNNECESSARY, n1: AIntByRef = IntByRef.UNNECESSARY, n2: AIntByRef = IntByRef.UNNECESSARY, maxSize1: ADoubleByRef = DoubleByRef.UNNECESSARY, maxSize2: ADoubleByRef = DoubleByRef.UNNECESSARY, pointOnEdgeFromLine: ABooleanByRef = BooleanByRef.UNNECESSARY, pointOnEdgeFromPoint: ABooleanByRef = BooleanByRef.UNNECESSARY, extendCookieCutLines: ABooleanByRef = BooleanByRef.UNNECESSARY, rotation: ADoubleByRef = DoubleByRef.UNNECESSARY, maxSizeGeneral: ADoubleByRef = DoubleByRef.UNNECESSARY, localAxesOnEdge: ABooleanByRef = BooleanByRef.UNNECESSARY, localAxesOnFace: ABooleanByRef = BooleanByRef.UNNECESSARY, restraintsOnEdge: ABooleanByRef = BooleanByRef.UNNECESSARY, restraintsOnFace: ABooleanByRef = BooleanByRef.UNNECESSARY, group: AStringByRef = StringByRef.UNNECESSARY, subMesh: ABooleanByRef = BooleanByRef.UNNECESSARY, subMeshSize: ADoubleByRef = DoubleByRef.UNNECESSARY): Int =
     ...
     */
    fun getEdgeConstraint(name: String, constraintExists: ABooleanByRef = BooleanByRef.UNNECESSARY): Int =
