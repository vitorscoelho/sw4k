...
interface SolidObjV14 : SapComponent {
     ...
     */
    fun getAutoMesh(name: String, meshType: AIntByRef = IntByRef.UNNECESSARY, n1: AIntByRef = IntByRef.UNNECESSARY, n2: AIntByRef = IntByRef.UNNECESSARY, n3: AIntByRef = IntByRef.UNNECESSARY, maxSize1: ADoubleByRef = DoubleByRef.UNNECESSARY, maxSize2: ADoubleByRef = DoubleByRef.UNNECESSARY, maxSize3: ADoubleByRef = DoubleByRef.UNNECESSARY, restraintsOnEdge: ABooleanByRef = BooleanByRef.UNNECESSARY, restraintsOnFace: ABooleanByRef = BooleanByRef.UNNECESSARY): Int =
