...
interface ResponseSpectrumV14 : SapComponent {
     ...
     * @return zero if the option is successfully retrieved; otherwise it returns a nonzero value.
     */
    fun getDirComb(name: String, myType: AIntByRef = IntByRef.UNNECESSARY, SF: ADoubleByRef = DoubleByRef.UNNECESSARY): Int =
     ...
     */
    fun getEccentricity(name: String, eccen: ADoubleByRef = DoubleByRef.UNNECESSARY): Int =
     ...
     */
    fun getLoads(name: String, numberLoads: AIntByRef = IntByRef.UNNECESSARY, loadName: AStringArrayByRef = StringArrayByRef.UNNECESSARY, func: AStringArrayByRef = StringArrayByRef.UNNECESSARY, sF: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY, cSys: AStringArrayByRef = StringArrayByRef.UNNECESSARY, ang: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY): Int =
     ...
     * @return zero if the option is successfully retrieved; otherwise it returns a nonzero value.
     */
    fun getModalComb_1(name: String, myType: AIntByRef = IntByRef.UNNECESSARY, f1: ADoubleByRef = DoubleByRef.UNNECESSARY, f2: ADoubleByRef = DoubleByRef.UNNECESSARY, periodicRigidCombType: AIntByRef = IntByRef.UNNECESSARY, td: ADoubleByRef = DoubleByRef.UNNECESSARY): Int =
     ...
     */
    fun setLoads(name: String, numberLoads: Int, loadName: AStringArrayByRef = StringArrayByRef.UNNECESSARY, func: AStringArrayByRef = StringArrayByRef.UNNECESSARY, sF: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY, cSys: AStringArrayByRef = StringArrayByRef.UNNECESSARY, ang: ADoubleArrayByRef = DoubleArrayByRef.UNNECESSARY): Int =
