...
interface AutoSeismicV14 : SapComponent {
    ...
    /**
     * This function retrieves auto seismic loading parameters for the Chinese_2002 2002 code.
     * @param name The name of an existing Quake-type load pattern with a Chinese_2002 2002 auto seismic load assignment.
    ...
    @Deprecated(
            ...
            replaceWith = ReplaceWith(
                    expression = "getEurocode82004_1(name,dirFlag,eccen,periodFlag,CT,userT,userZ,topZ,bottomZ,eURO2004Country,eURO2004SpectrumType,eURO2004GroundType,eURO2004ag,eURO2004S,eURO2004Tb,eURO2004Tc,eURO2004Td,eURO2004Beta,eURO2004q,eURO2004Lambda)",
                    imports = arrayOf("vitorscoelho.sw4k.sap.sapmodel.definitions.loadpatterns.AutoSeismic")
            ),
     ...
     * @return zero if the parameters are successfully retrieved; otherwise it returns a nonzero value.
     */
    fun getEurocode82004_1(name: String, dirFlag: AIntByRef = IntByRef.UNNECESSARY, eccen: ADoubleByRef = DoubleByRef.UNNECESSARY, periodFlag: AIntByRef = IntByRef.UNNECESSARY, CT: ADoubleByRef = DoubleByRef.UNNECESSARY, userT: ADoubleByRef = DoubleByRef.UNNECESSARY, userZ: ABooleanByRef = BooleanByRef.UNNECESSARY, topZ: ADoubleByRef = DoubleByRef.UNNECESSARY, bottomZ: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Country: AIntByRef = IntByRef.UNNECESSARY, eURO2004SpectrumType: AIntByRef = IntByRef.UNNECESSARY, eURO2004GroundType: AIntByRef = IntByRef.UNNECESSARY, eURO2004ag: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004S: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Tb: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Tc: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Td: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Beta: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004q: ADoubleByRef = DoubleByRef.UNNECESSARY, eURO2004Lambda: ADoubleByRef = DoubleByRef.UNNECESSARY): Int =
            callFunctionInt("GetEurocode82004_1", name, dirFlag, eccen, periodFlag, CT, userT, userZ, topZ, bottomZ, eURO2004Country, eURO2004SpectrumType, eURO2004GroundType, eURO2004ag, eURO2004S, eURO2004Tb, eURO2004Tc, eURO2004Td, eURO2004Beta, eURO2004q, eURO2004Lambda)
    ...
    /**
     * This function assigns auto seismic loading parameters for the Chinese_2002 2002 code.
     * @param name The name of an existing Quake-type load pattern.
     * @param dirFlag This is 1, 2 or 3, indicating the seismic load direction.
     * * 1 = Global X
     * * 2 = Global Y
    ...
    @Deprecated(
            ...
            replaceWith = ReplaceWith(
                    expression = "setEurocode82004_1(name,dirFlag,eccen,periodFlag,CT,userT,userZ,topZ,bottomZ,eURO2004Country,eURO2004SpectrumType,eURO2004GroundType,eURO2004ag,eURO2004S,eURO2004Tb,eURO2004Tc,eURO2004Td,eURO2004Beta,eURO2004q,eURO2004Lambda)",
                    imports = arrayOf("vitorscoelho.sw4k.sap.sapmodel.definitions.loadpatterns.AutoSeismic")
            ),
            level = DeprecationLevel.WARNING
    )
