...
fun main() {
    ...
    sapModel.initializeNewModel(units = Units.kN_cm_C)
    sapModel.file.newBlank()

    //Definição dos materiais
    sapModel.propMaterial.setMaterial(name = "Concreto", matType = MatType.MATERIAL_CONCRETE, color = 25, notes = "Notas e notas")
    ...
    println("MatType: ${matTypeRef.value}")
