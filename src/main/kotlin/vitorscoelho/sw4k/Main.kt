...
//    sapModel.frameObj.getPoints(FrameName(2), PointName(0), PointName(1))
//    ReDim PointLoadValue (5)
//    PointLoadValue(2) = -10
//    val pointLoadValue= doubleArrayOf(0.0,0.0,-10.0,0.0,0.0,0.0).byRef()
//    sapModel.pointObj.setLoadForce(PointName(0), "2", pointLoadValue)
//    sapModel.frameObj.setLoadDistributed(FrameName(2), "2", 1, 10, 0, 1, 1.8, 1.8)
